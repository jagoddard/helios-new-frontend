        ...
        <InvestorContainer selectedTab='Press Releases'>
            <section className='flex flex-col md:flex-row'>
                <div className='w-full md:w-[30%] bg-[#353535] py-6 md:pt-20 pl-10 md:pl-20 pr-10 flex md:flex-col flex-row gap-3 overflow-auto'>
                    <div onClick={()=>router.push(routes.latestNewReleases)} className={`${marketTabs === "LatestNewsReleases" ? `marketTab w-[100%] border-l-4 border-primaryColor` : ``} py-2 px-3 cursor-pointer`}><p className='m-0 text-xl text-white w-[200px]'>Latest News Releases</p></div>
