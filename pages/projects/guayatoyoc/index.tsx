        ...
        <ProjectContainer selectedTab="Guayatoyoc" >
            <div className='border-b-8 border-primaryColor bg-darkTheme'>
                ...
                <section className='px-5 md:px-20 py-10'>
                    ...
                    <p className='text-white mt-3'>In March, 2019 Pluspetrol Resources Corporation B.V. ("Pluspetrol") acquired 100% of the issued and outstanding common shares of LSC Lithium Corporation for a cash consideration of approximately CDN $111million. Dajin is now partnered with Pluspetrol who have earned a 51% interest in Dajin Resources S.A. with the expenditure of US$1,250,000 on the concessions and payment of $600,000 to Dajin Resources Corp. Pluspetrol has created the company Litica Resources S.A. for exploration and development of their concessions. Litica's exploration team is currently reviewing the Guayatoyoc and Guayatayoc salars exploration and drilling data acquired in the LSC Litium transaction. Pluspetrol is a private, independent, international energy company with over 40 years experience in the exploration and production of oil and gas. Pluspetrol is the largest hydrocarbon producer in Peru. With operations in Angola, Argentina, Bolivia, Colombia, Peru, and offices in United States, Uruguay and the Netherlands, Pluspetrol promotes energy development and fosters activities at an international level. Pluspetrol has created the company Litica Resources S.A. to enter the "battery metals" business.</p>
                    <div className='my-6 flex justify-center'>
