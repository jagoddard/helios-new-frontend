            ...
            <div className='border-b-8 border-primaryColor bg-darkTheme'>
                <section className='px-5 md:px-20 py-10'>
                    ...
                    <div className='md:w-[60%] m-auto bg-bgColor py-5 px-8 mt-10 rounded-2xl projectBoxShadow'>
                        ...
                        <p className='text-center mt-6 text-white'>The concessions are 49% owned by D2 LITHIUM Corp. and 51% owned by LITICA Resources S.A.</p>
                    </div>
                </section>
                <section className='px-5 md:px-20 py-10'>
                ...
                <section className='px-5 md:px-20 py-10'>
                    ...
                    <p className=' text-white mt-3'>Lithium is produced as one of several byproducts at most brine operations and the cost of production depends on the chemistries of the brines used as source materials for the solar evaporation ponds. Generally the greater the quantity of Magnesium and Calcium present in the brine relative to the Lithium grade and the more complex the chemistry of the brine the greater the costs of production will be. Today, Direct Lithium Extraction technologies are being commercially tested in Argentina and D2 Lithium intends to utilize similar technologies for its asset base.</p>
                    <div className='my-6 flex justify-center'>
