        ...
        <div>
            ...
            <section className={styles.homeAbout}>
                <div className={styles.homeAboutInner}>
                    ...
                    <p className={styles.homeAboutDesc}>HeliosX is an industry leading, integrated Lithium exploration company, and one of the few international investment opportunities with approximately 825,000 gross acres diversified across three highly prospective regions: Jujuy (Argentina ~ 230,000 acres), Nevada (USA ~ 17,000 acres) and Alberta (Canada ~ 583,952 acres). </p>
