        ...
        <div>
            ...
            <section className={styles.homeAbout}>
                <div className={styles.homeAboutInner}>
                    ...
                    <p className={styles.homeAboutDesc}>HeliosX is an industry leading, integrated Lithium exploration company, and one of the few international investment opportunities with 560,000 acres diversified across three highly prospective regions: Jujuy (Argentina ~ 230,000 acres), Nevada (USA ~ 10,800 acres) and Alberta (Canada ~ 315,060 acres). </p>
