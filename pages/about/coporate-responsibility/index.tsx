        ...
        <AboutContainer selectedTab='coporate-responsability'>
            <section className='py-12 md:py-10 px-5 md:px-20 relative border-b-8 border-primaryColor bg-darkTheme'>
                ...
                <div className=''>
                    ...
                    <p className='text-xl font-normal mt-6 text-white'>D2 Lithium is an energy metals company that believes in responsibility, accountability and cooperation with all of our stakeholders. Our objective is to build and maintain prosperity for all stakeholders through responsible business practices</p>
                    <p className='text-xl font-normal mt-2 text-white'>D2 Lithium is committed to responsible business conduct, placing the utmost importance on respecting the safety and health of our employees, protecting the environment, and respecting the human rights of all people, especially our employees and the residents of the communities in which we operate.</p>
                </div>
            </section>
        </AboutContainer>
    )
