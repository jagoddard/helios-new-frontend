    ...
    <AboutContainer selectedTab="management-team">
      <section className="bg-darkTheme relative py-12 md:py-10 px-5 md:px-20 md:pr-[45%] border-b-8 border-primaryColor">
        ...
        <AboutData
          title="Edward Loven"
          subTitle="Director"
          desc="Mr. Loven has 40 years of domestic and international experience in managing and marketing exploration phase opportunities in the oil & gas industry. Mr. Loven co-founded the Sandex Group from 1985 to 2001 and was directly responsible for Sandex’s success related to the structuring, negotiating and completion of large green[1]field transactions. Mr. Loven has extensive industry experience in North America within the Oil & Gas industry. Mr. Loven has become an industry leader in developing corporate relations with First Nations. Mr. Loven has implemented corporate structures and policies with First Nations partners. Mr. Loven is currently a board member of environmentally focused innovative green technologies and a private domestic heavy oil production company."
        />
        <AboutData
          title="Michael Hibberd"
          subTitle="Director"
          desc="Mr. Hibberd is currently Chairman of the Board of Canacol Energy Ltd. Mr. Hibberd has been Chairman and CEO of MJH Services Inc., a corporate finance advisory firm since 1995. He is also currently Vice Chairman of Sunshine Oilsands Ltd. and Chairman of PetroFrontier Corp. and serves as a board member of CanAsia Energy Corp. Formerly, he was Chairman of Heritage Oil Plc, Heritage Oil Corporation and Greenfields Petroleum Corporation; and former director of Montana Exploration Corp., Avalite Inc., Challenger Energy Corp., Deer Creek Energy, Iteration Energy Ltd., Pan Orient Energy Corp., Rally Energy Corp., Sagres Energy, Skope Energy Inc. and Zapata Energy Corporation. Mr. Hibberd holds a BA and an MBA from Western University and an LLB from the University of Toronto. He is also a member of the Law Society of Upper Canada."
        />
        <p className="text-2xl md:text-4xl font-semibold mt-20 text-white">
          DAJIN RESOURCES S.A.
        </p>
        <AboutData
        ...
        <img
          src="/bgAbout.svg"
          className="hidden md:w-[45%] md:block absolute top-0 right-0"
        />
      </section>
    </AboutContainer>
  );
