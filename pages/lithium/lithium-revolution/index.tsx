    ...
    <LithiumContainer selectedTab="Lithium Revolution">
      <section className="px-5 md:px-20 py-10 border-b-8 border-primaryColor bg-darkTheme">
        ...
        <p className="mb-10 text-white">
          The shift to clean energy has opened a window of opportunity for
          energy metals, such as Lithium. For clean energy to be useful to
          society, the efficient storage of energy is paramount. Advanced
          batteries allow our cars to run without using gasoline and batteries
          allow renewable energy to be stored when the sun isn't shining and the
          wind isn't blowing.
        </p>
        <p className="mb-10 text-white mt-3">
          ...
          infographic on why Lithium is the key ingredient in today's
          technology.
        </p>
