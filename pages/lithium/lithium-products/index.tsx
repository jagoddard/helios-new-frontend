        ...
        <LithiumContainer selectedTab='Lithium Products'>
            <div className='border-b-8 border-primaryColor bg-darkTheme'>
                ...
                <p className='text-headerMobile md:text-header font-semibold mb-3 text-white'>ALUMINUM-LITHIUM ALLOY</p>
                    ...
                    <p className='text-headerMobile md:text-header font-semibold my-3 text-white'>CELL PHONES, COMPUTERS, POWER TOOLS, IPODS AND IPADS.</p>
                    <div className='my-6 flex justify-center'>
                        <img src='/lsd14.jpg' />
                    </div>
