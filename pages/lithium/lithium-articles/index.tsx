    ...
    <LithiumContainer selectedTab="Lithium Articles">
      <div className="border-b-8 border-primaryColor bg-darkTheme">
        <section className="px-5 md:px-20 py-10">
          ...
          <p className="mb-1 text-white">
            Before the First Tesla Gigafactory Has Even Been Built, CA wants to
            be Home to Tesla's 2nd Gigafactory 2.0:
            <Link
          ...
          <p className="mb-1 text-white">
            Elon Musk Tells Stephen Colbert Why He Released Tesla Patents to the
            EV Market:
            <Link
              href="https://www.ecowatch.com/2014/07/25/elon-musk-stephen-colbert/"
              target="_blank"
              className="text-primaryColor mb-3"
              passHref
            >
          ...
          <p className="mb-1 text-white">
            Since its launch in 1995, TopSpeed.com has been providing news in
            the automotive industry. They currently average 8 million page views
            per month and have the No. 3 ranking on Cision's "2013 Top 50 Auto
            Blogs" list.
          </p>
          <p className="mb-1 text-white mt-3">
          ...
          <p className="text-white">
            Navigant Research is a market research and consulting team that
            ...
            end-user primary research and demand assessment, and deep
          ...
          <p className="text-white">
            Argonne National Laboratory. Affiliated with the US Department of
            Energy
          </p>
          <p className="text-white mt-3">
            Argonne National Laboratory located near Lemont, IL outside Chicago
            is the first science and engineering research national laboratory in
            the United States,receiving this designation on July 1, 1946.
            Argonne is a multidisciplinary science and engineering research
            center, where "dream teams" of world-class researchers work
            alongside experts from industry, academia and other government
            laboratories to address vital national challenges in clean energy,
            environment, technology and national security. See article on
            website:
            <Link
              href="https://rmi.org/Content/Images/Lithium%20ion.PDF"
              target="_blank"
              className="text-primaryColor mb-3"
              passHref
            >
          ...
          <p className="text-white">
            Argentina equities still hot despite the country's debt woes -
            really
            <Link
          ...
          <p className="text-primaryColor mb-6">
            ...
            government is seeking in increase foreign investment into the
            country, prodding potential upside to the mining sector in the
            coming quarters"
          </p>
          <p className="mb-3 text-white">
            ...
            modest growth in the industry value. Argentina's regulatory
            environment is relatively favourable at present. Federal government
            policies have yet to restrict or regulate the mining sector
            extensively given it's previously weak presents. Because mineral
            rights in Argentina are decentralized and regulated by the
            individual provinces, we expect exploration and mine development
            will centre on provinces that are commented towards mining."
          </p>
          ...
          <p className="text-white">
            ...
            <Link
              href="https://heliosx.ca/files/dargonne-report.pdf"
              target="_blank"
              className="text-primaryColor mb-3"
              passHref
            >
